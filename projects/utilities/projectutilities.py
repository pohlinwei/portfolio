...
SUMMARY_PREFIX = PREFIX_FORMAT.format(type='SUMMARY')
...
PREFIXES = [NAME_PREFIX, IMG_PREFIX, SUMMARY_PREFIX, DESCRIPTION_PREFIX, TOOLS_PREFIX, DATE_PREFIX, PAGE_PREFIX,

from .projectutilities import NAME_PREFIX, IMG_PREFIX, SUMMARY_PREFIX, DESCRIPTION_PREFIX, TOOLS_PREFIX,\
...
class ProjectParser:
    ...
    Attributes:
        ...
        summary_value: A string which summarises the project.
    ...
    def __init__(self, project_strings):
        ...
        self.summary = self.extract_value(project_strings, SUMMARY_PREFIX)
